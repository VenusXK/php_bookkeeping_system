                ...
                <tr>
                    <td>
                        <div class="navIndex" id='ls1' style="height:55px;margin: auto;width:200px;border-radius: 20px;padding:0px;overflow: hidden">
                            <div class="navIndex" id='ls2' style="background: black;margin: auto;width:50%;border-radius: 0px;"><a href="assetIndex.php" style="color:white;">资产</a></div>
                            <div class="navIndex" id='ls3' style="background:linear-gradient(135deg,#77FFCC,#AAFFEE);margin: auto;width:50%;border-radius: 20px;border-radius: 0px;"><a href="assetIndexplus.php" style="color:black;">动账</a></div>
                        </div>
                    </td>
                    <td>
