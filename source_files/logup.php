<html>
    ...
    <body >
        <div class="logTitleDIV">注册&nbsp;
            <a href='login2.php'  class="logA" ><span>登录</span></a></div>
        <div class="logFormDIV">
                <form method="post">
                    <input class="logInput" name='uName' placeholder='输入用户名'>
                    <input class="logInput" name='uPw' placeholder='输入密码'>
                    <input  class='logSubmit' type='submit' style="padding-left:0px" value='提交'/>
                    <input name='inf' value="logup" style="display:none">
                </form>
        </div>
